...
switch(THIS_PAGE){
    ...
    case 'index.php':
        $title = "Hongbin Liu's WEB120 Big Website";
        $logo = "fa-home";
    break;
        
    case 'big1.php':
        $title = "Hongbin Liu's WEB120 Big Research Website";
    break;
    ...
    case 'calendar.php':
        $title = "Hongbin Liu's WEB120 Big Website Calendar";
    break;
        
    case 'web.php':
        $title = "Hongbin Liu's WEB120 Big Website youtube";
    break;
