...
<html lang="en">
 ...
 <body>
   ...
   <main>
     ...
     <nav id="cssmenu">
            <ul>
                ...
                <li><a href="#">Google Tools</a>
                    <ul>
                        <li><a href="accessibility.php"><i class="fa fa-fw fa-desktop"></i> Accessibility</a></li>
     ...
     <!-- START LEFT COLUMN -->
<section>
<h2>Search Engine Optimization (SEO) - Responsive Youtube Video</h2>
           <p>Watching the Supporting instructional video to create the contents fot this page</p>
           <div class='embed-container'>
               <iframe src='https://www.youtube.com/embed/hF515-0Tduk' frameborder='0' allowfullscreen></iframe>
           </div>
</section>
<!-- END LEFT COLUMN -->
