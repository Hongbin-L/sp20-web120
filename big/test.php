...
<body>
	...
	<?php
        ...
        $siteKey = "6Le_4NYUAAAAAE0yK74oIUDmnp3xHRCyBe8hJyFx";
        $secretKey = "6Le_4NYUAAAAAH34UMWhNWZGtJI7E6zJa9Dg1KRB";
    
        $toAddress = "hongbin.liu@seattlecentral.edu";  //place your/your client's email address here
        $toName = "King"; //place your client's name here
        $website = "Red Star";  //place NAME of your client's website
