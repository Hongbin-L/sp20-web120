...
<!-- START LEFT COL -->
<section>
 <h2 class="pageID"></h2> <!-- START LEFT COL -->
<section>
<div class="embed-container">
<!-- Insert Live YouTube video -->
<iframe src='https://www.youtube.com/embed/EEIk7gwjgIM' frameborder='0' allowfullscreen></iframe>
</div>
</section>
 <!-- END LEFT COL -->
    <p>NASA ISS Live Stream - Earth From Space ISS Live Feed ISS Tracker Live Chat</p>
 <!-- START RIGHT COL -->
<aside>
 <h3>DOT Camera</h3>
 <div class="dot">
...
<!-- START Footer -->
<footer>
  <p><small>&copy; 2020 - 2020 by <a href="contact.php" target="_blank">Hongbin Liu</a>, All Rights Reserved ~ <a href="http://validator.w3.org/check/referer" target="_blank">Valid HTML</a> ~ <a href="http://jigsaw.w3.org/css-validator/check?uri=referer" target="_blank">Valid CSS</a></small></p>
</footer>
<!-- END Footer --> 
<!-- END WRAPPER -->
